...
const servicesData = [
  ...
  },
  {
    id: 2,
    title: "치아교정",
    subtitle: "증상별·장치별 치아교정, 교정 사후관리\n그리고 온가족만의 특별한 치아교정",
    image: "/image/section2_image/치아교정.webp",
    description: "개인 맞춤형 치아교정으로 아름답고 건강한 치열을 만들어드립니다",
    features: [
      "투명교정 (인비절라인, 클리어어라이너)",
      "메탈 브라켓 교정",
      "세라믹 브라켓 교정",
  ...
  },
  {
    id: 4,
    title: "통합치료",
    subtitle: "충치치료, 사랑니 발치, 전신질환, 수면치료\n통증을 줄이기 위한 온가족의 노력",
